...
do
    ...
    do
        ...
        do
            ...
            option="--normalize ${NORM} --epochs 1000 --data ${DATA} --model VAR --save_dir save --save_name var.${LOG}.w-${window}.h-${HORIZON}.pt --horizon ${HORIZON} --window ${window} --metric 0 --weight_decay ${decay}"
